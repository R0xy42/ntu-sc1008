...
//
template <typename T>
inline T calArea(T side){return side*side;}

template <typename T>
inline T calArea(T length, T width){return length*width;}

template <class Any>
inline Any calArea(Any b1, Any b2, Any height){return 0.5*(b1+b2)*height;}
